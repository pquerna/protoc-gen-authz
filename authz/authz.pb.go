...
type MessageRoles struct {
	...
	CustomRoles []string `protobuf:"bytes,1,rep,name=custom_roles,json=customRoles,proto3" json:"custom_roles,omitempty"`
}

func (x *MessageRoles) Reset() {
	*x = MessageRoles{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageRoles) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageRoles) ProtoMessage() {}

func (x *MessageRoles) ProtoReflect() protoreflect.Message {
	mi := &file_authz_authz_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageRoles.ProtoReflect.Descriptor instead.
func (*MessageRoles) Descriptor() ([]byte, []int) {
	return file_authz_authz_proto_rawDescGZIP(), []int{2}
}

func (x *MessageRoles) GetCustomRoles() []string {
	if x != nil {
		return x.CustomRoles
	}
	return nil
...
var file_authz_authz_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: (*MessageRoles)(nil),
		Field:         5999,
		Name:          "authz.role",
		Tag:           "bytes,5999,opt,name=role",
		Filename:      "authz/authz.proto",
	},
}
...
var (
	// optional authz.MessageRoles role = 5999;
	E_Role = &file_authz_authz_proto_extTypes[2]
)
...
var file_authz_authz_proto_rawDesc = []byte{
	...
	0x22, 0x31, 0x0a, 0x0c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x6f, 0x6c, 0x65, 0x73,
	0x12, 0x21, 0x0a, 0x0c, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x52, 0x6f,
	0x6c, 0x65, 0x73, 0x2a, 0x47, 0x0a, 0x05, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x12, 0x0b, 0x0a, 0x07,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x3a, 0x49,
	...
	0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0xef, 0x2e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13,
	0x2e, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x6f,
	0x6c, 0x65, 0x73, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x71, 0x75, 0x65, 0x72, 0x6e, 0x61, 0x2f,
...
var file_authz_authz_proto_goTypes = []interface{}{
	...
	(*MessageRoles)(nil),                // 3: authz.MessageRoles
...
var file_authz_authz_proto_depIdxs = []int32{
	...
	6, // 3: authz.role:extendee -> google.protobuf.MessageOptions
	1, // 4: authz.method:type_name -> authz.MethodOptions
	2, // 5: authz.service:type_name -> authz.ServiceOptions
	3, // 6: authz.role:type_name -> authz.MessageRoles
